...
public class GraphicsContext
{
    ...
    /**
     * The position on the destination surface which corresponds to the world's
     * origin. For example, if ox is 10, and an image is blitted at x=30, then
     * the image will be blitted at x=40 on the destination surface.
     */
    private int ox;
    ...
    /**
     * The clipping rectangle of the destination surface (not in world
     * coordinates).
     */
    private Rect clip;
    ...
    {
        this.blit( surface, new Rect( 0, 0, surface.getWidth(), surface.getHeight() ), x, y, Surface.BlendMode.NONE );
    }
