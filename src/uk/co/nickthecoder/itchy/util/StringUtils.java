...
public class StringUtils
{
    ...
    /**
     * Returns true if the string is null, or if it equals "" after being trimmed.
     */
    ...
    /**
     * Pad value with spaces if value is shorter then newLength, truncate it if it is longer.
     */
