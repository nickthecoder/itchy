...
public class RGBAProperty<S> extends Property<S,RGBA>
{
    ...
    @Override
    public Component createComponent( final S subject, final boolean autoUpdate, final ComponentChangeListener listener )
            ...
            NoSuchFieldException
    {
        ...
        final TextBox textBox = new TextBox( color == null ? "" : this.includeAlpha ? color.getRGBACode() : color.getRGBCode() );
