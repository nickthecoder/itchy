...
public class GRGBAProperty<S> extends GProperty<S, RGBA>
{
    private final boolean allowNull;

    private final boolean includeAlpha;

    public GRGBAProperty( String label, String access, boolean allowNull, boolean includeAlpha )
    {
        super(label, access);
        ...
        SecurityException, IllegalAccessException, InvocationTargetException, NoSuchFieldException
    {
        ...
        if (autoUpdate) {
            ...
            textBox.addChangeListener(new ComponentChangeListener() {
                ...
                {
                    try {
                        GRGBAProperty.this.update(subject, textBox);
                        if (listener != null) {
                            listener.changed();
                        }
                    } catch (Exception e) {
