...
public class NinePatchEditor extends SubEditor
{
    ...
    private TableModel createTableModel()
    {
        ...
        for ( String soundName : this.editor.resources.ninePatchNames() ) {
            ...
            TableModelRow row = new ReflectionTableModelRow<NinePatchResource>( resource, attributeNames );
            model.addRow( row );
        }
        return model;
    }
    ...
    protected void edit( GridLayout grid, Object resource )
    {
        ...
        this.txtFilename = new FilenameComponent( this.editor.resources, this.currentResource.filename );
        ...
        this.pickMiddle = new PickerButton<NinePatch.Middle>( "Middle", ninePatch.middle, NINE_PATCH_NAMES_HASH );
    ...
    protected void onOk()
    {
        ...
        try {
            this.currentResource.ninePatch.marginBottom = Integer.parseInt( this.txtBottom.getText() );
        } catch ( NumberFormatException e ) {
    ...
    public void onAdd( File file )
    {
        if ( file == null ) {
            ...
            try {
                NinePatch ninePatch = new NinePatch( new Surface( this.editor.resources.resolveFilename( filename ) ),
                        0, 0, 0, 0 );
                this.currentResource = new NinePatchResource( this.editor.resources, name, filename, ninePatch );
                this.adding = true;
                Itchy.singleton.hideWindow( this.openDialog );
    ...
    public class ExplodedImage extends Component
    {
        ...
        private final RGBA[] backgrounds = new RGBA[] { null, new RGBA( 0, 0, 0 ), new RGBA( 255, 255, 255 ),
                new RGBA( 128, 128, 128 ) };
        ...
        public void render( GraphicsContext gc )
        {
            ...
            if ( background == null ) {
                ...
                Rect whole = new Rect( 0, 0, this.surface.getWidth() + this.spacing * 2, this.surface.getHeight()
                        + this.spacing * 2 );
            ...
            gc.blit( this.surface, srcRect, width - right + this.spacing * 2, 0, Surface.BlendMode.NONE );
            ...
            gc.blit( this.surface, srcRect, left + this.spacing, top + this.spacing, Surface.BlendMode.NONE );
            ...
            gc.blit( this.surface, srcRect, 0, height - bottom + this.spacing * 2, Surface.BlendMode.NONE );
            ...
            gc.blit( this.surface, srcRect, width - right + this.spacing * 2, height - bottom + this.spacing * 2,
            		Surface.BlendMode.NONE );
