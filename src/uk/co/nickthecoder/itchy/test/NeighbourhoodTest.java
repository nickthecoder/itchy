...
public class NeighbourhoodTest
{
    	...
    	throws Exception
    {
		...
		c30x30 = resources.getCostume( "30x30" );
		c10x30 = resources.getCostume( "10x30" );
		c30x10 = resources.getCostume( "30x10" );
    }
    ...
    public void createSquares()
    {
    	...
    	spcs( nbh, c30x30, 0, 0 );
    	spcs( nbh, c30x30, 60, 0 );
    	spcs( nbh, c30x30, -40, 0 );
    	spcs( nbh, c30x30, 290, 0 );
    	spcs( nbh, c30x30, -290, 0 );
    }
	...
	public void createRows()
	{
    	...
    	spcs( nbh, c30x30, 0, 0 );
    	spcs( nbh, c30x30, 0, 60 );
    	spcs( nbh, c30x30, 0, -40 );
    	spcs( nbh, c30x30, 0, 290 );
    	spcs( nbh, c30x30, 0, -290 );
    }
    ...
    public void actorsInSquares()
    {
    	...
    	SinglePointCollisionStrategy a = spcs( nbh, c30x30, 0, 0 );
    	assertEquals( a.getSquare(), nbh.getSquare( 0,0 ) );
    	
    	SinglePointCollisionStrategy b = spcs( nbh, c30x30, 10, 0 );
    	assertEquals( b.getSquare(), nbh.getSquare( 0,0 ) );
    	
    	SinglePointCollisionStrategy c = spcs( nbh, c30x30, 50, 0 );
    	assertNotSame( a.getSquare(), c.getSquare() );
    	
    	SinglePointCollisionStrategy d = spcs( nbh, c30x30, 0, 50 );
    	assertNotSame( a.getSquare(), d.getSquare() );
    	
    	SinglePointCollisionStrategy e = spcs( nbh, c30x30, 0, 49 );
    	assertSame( a.getSquare(), e.getSquare() );
    	
    	SinglePointCollisionStrategy f = spcs( nbh, c30x30, 49, 0 );
    	assertSame( a.getSquare(), f.getSquare() );
    	
    	SinglePointCollisionStrategy g = spcs( nbh, c30x30, -1, 0 );
    	//assertNotSame( a.getSquare(), g.getSquare() );
    	
    	SinglePointCollisionStrategy h = spcs( nbh, c30x30, -49, 0 );
    	//assertNotSame( a.getSquare(), h.getSquare() );
    	assertSame( g.getSquare(), h.getSquare() );

    	SinglePointCollisionStrategy i = spcs( nbh, c30x30, -51, 0 );
    	assertNotSame( i.getSquare(), h.getSquare() );
    	assertTrue( i.getSquare().getNeighbouringSquares().contains( h.getSquare() ) );
    	

    	SinglePointCollisionStrategy z = spcs( nbh, c30x30, 0, 0 );
