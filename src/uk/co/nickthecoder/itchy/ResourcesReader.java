...
public class ResourcesReader
{
    ...
    private void readResources( XMLTag resourcesTag )
        throws Exception
    {
    ...
    private void readNinePatches( XMLTag eightPatchesTag )
        throws Exception
    {
    ...
    private void readPoses( XMLTag posesTag )
        throws Exception
    {
    ...
    private void readSounds( XMLTag soundsTag )
        throws Exception
    {
    ...
    private void readAnimations( XMLTag animationsTag )
        throws XMLException
    {
    ...
    private void readCostumes( XMLTag costumesTag )
        throws Exception
    {
        for ( Iterator<XMLTag> i = costumesTag.getTags( "costume" ); i.hasNext(); ) {
            ...
            costume.behaviourClassName = costumeTag.getOptionalAttribute( "behaviour", NullBehaviour.class.getName() );
    ...
    private void readFonts( XMLTag fontsTag )
        throws Exception
    {
    ...
    private void readScenes( XMLTag scenesTag )
        throws Exception
    {
