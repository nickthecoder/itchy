...
public class Notebook extends Container
{
    ...
    /**
     * Reverses the normal order of rendering, so that the tabs are blitted
     * after the pages. This allows the tabs to slightly overlap the pages, if
     * the notebook has a negative spacing.
     */
    @Override
