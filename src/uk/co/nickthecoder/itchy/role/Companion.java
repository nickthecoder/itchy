...
public abstract class Companion extends AbstractRole
{
    ...
    public static abstract class AbstractCompanionBuilder<C extends Companion, B extends AbstractCompanionBuilder<C, B>>
    {
        ...
        /**
         * Uses a different Costume, the costume is found by looking up 'companionType' within the source actor's costume, and using the
         * result as a costume name.
         * <p>
         * For example, imagine we have a costume called "bigShip". Create a string within bigShip, named "bullet" with a value "redBullet".
         * We can now create a bullet like so :
        ...
        /**
         * Chooses which pose to use from the source's costume. Consider using {@link #eventName(String)} instead, as it can also initiate
         * an animation and a sound effect when the actor is created.
         * 
         * @param poseName
        ...
        {
            this.companion.pose = this.companion.source.getCostume().getPose(poseName);
            return getThis();
        }

        /**
         * The companion will fire this event when its Actor is created. The event can select a Pose, an Animation, and can play a sound. If
         * you only want to select a pose, then use {@link #pose(String)}.
         * 
         * @param eventName
        ...
        /**
         * @param forwards
         *        How far forwards/backwards to move from the source actor. Can be used in conjunction with {@link #offset(double, double)}
         *        and {@link #offsetSidewards(double)}.
         * @return this
         */
        ...
        /**
         * Aims the actor in the direction given. This will affect the direction the actor moves using {@link Actor#moveForwards(double)}.
         * It will NOT affect the orientation of the actor's image.
         * 
         * @param degrees
        ...
        public Actor createActor()
        {
            return this.companion.createActor();
        }
