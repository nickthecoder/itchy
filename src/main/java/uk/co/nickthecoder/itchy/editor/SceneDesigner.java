...
public class SceneDesigner implements MouseListener, KeyListener
{
    ...
    {
        Rect viewsRect = new Rect(0, this.toolbar.getHeight(), width, height - this.toolbar.getHeight());
        Rect editRect = new Rect(0, 0, width, height - this.toolbar.getHeight());
    ...
    private void createActorPage()
    {
        ...
        this.actorPropertiesForm = new SceneDesignerPropertiesForm<Actor>(
            "actor", this, this.currentActor, this.currentActor.getProperties());
                    ...
                    public void pick(CostumeResource costumeResource)
                    {
                        if (costumeResource == null) {
                            ...
                            Pose pose = costumeResource.getCostume().getPose(
                                SceneDesigner.this.currentActor.getStartEvent());
    ...
    private void createRolePage()
    {
        ...
        this.roleClassName = new ClassNameBox(
            this.editor.getScriptManager(), sdb.actualRole.getClassName(), Role.class);
    ...
    private void createMakeupPage()
    {
        ...
        this.makeupClassName = new ClassNameBox(
            this.editor.getScriptManager(), Appearance.getMakeupClassName(makeup), Makeup.class);
    ...
    public void mouseMove(MouseMotionEvent event)
    {
        ...
        if (this.mode == MODE_STAMP_COSTUME) {
            ...
            if ((newX != this.currentActor.getX()) || (newY != this.currentActor.getY())) {
                this.undoList.apply(new UndoMoveActor(this.currentActor, newX - this.currentActor.getX(),
